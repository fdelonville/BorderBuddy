...
public interface DayService {
    ...
    void setDayRangeType(LocalDate date1, LocalDate date2, Type type, Employee employee);
    void setDayRangeStatus(LocalDate date1, LocalDate date2, Status status, Employee employee);
}
